...
class _WrapperState extends State<Wrapper> with TickerProviderStateMixin {
  ...
  void initState() {
    tabbars = [
      ...
      new _TabbarItem(PageStorageKey('BlockChain'), '区块链', Icons.all_inclusive,
          BlockChain()),
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: tabbars.map((_TabbarItem tabbarItem) {
            return BottomNavigationBarItem(
              ...
              activeIcon:
                  Icon(tabbarItem.icon, color: Color.fromRGBO(91, 134, 229, 1)),
              title: Text(
                tabbarItem.name,
                style: TextStyle(color: Color.fromRGBO(91, 134, 229, 1)),
              ),
            );
          }).toList(),
        ));
